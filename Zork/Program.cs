...
namespace Zork
{
    ...
    internal class Program
    {
        ...
        private static void InitializeRoomDescriptions()   //3.1 stuff
        {
            ...
            Rooms[1, 1].Description = "This is a open field west of a white house, with a boarded front door."; //west of house
            Rooms[1, 2].Description = "You are behind the white house. In one corner of the house there is a small window that is slightly ajar"; //behind house
            ...
            Rooms[2, 1].Description = "You are facing the north side of a white house. There is no door here and all windows are barred"; //North of house
